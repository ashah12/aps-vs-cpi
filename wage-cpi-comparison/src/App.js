...
// // // // //         // Validate headers
// // // // //         if (!headers.includes('year') || !headers.includes('wage') || !headers.includes('cpi')) {
// // // // //           alert('Invalid CSV format. Required columns: year, wage, cpi');
// // // // //           return;
// // // // //         }
...
// // // // //           if (values.length !== 3) {
// // // // //             alert(`Error in row ${index + 1}: Invalid number of columns`);
// // // // //             return null;
// // // // //           }

// // // // //           const year = parseInt(values[headers.indexOf('year')].trim());
// // // // //           const wage = parseFloat(values[headers.indexOf('wage')].trim());
// // // // //           const cpi = parseFloat(values[headers.indexOf('cpi')].trim());

// // // // //           if (isNaN(year) || isNaN(wage) || isNaN(cpi)) {
// // // // //             alert(`Error in row ${index + 1}: Invalid numeric value`);
// // // // //             return null;
// // // // //           }

// // // // //           return { year, wage, cpi };
// // // // //         }).filter(Boolean);
...
// // // // //         setYearOptions([...new Set(parsedData.map(item => item.year))].sort());
...
// // // // //       .map(d => ({
// // // // //         ...d,
// // // // //         gap: d.wage - d.cpi // Calculate the gap (Real Wage Change)
// // // // //       }));
...
// // // // //     return customData
// // // // //       .filter(d => d.year >= projectionStartYear && d.year <= endYear)
// // // // //       .map((d, idx) => {
// // // // //         if (idx > 0) {
// // // // //           expected = expected * (1 + d.cpi / 100);
// // // // //           actual = actual * (1 + d.wage / 100);
// // // // //         }
...
// // // // //         <div className="h-96">
// // // // //           <ResponsiveContainer width="100%" height="100%">
// // // // //             <LineChart data={salaryProjectionData}>
// // // // //               <CartesianGrid strokeDasharray="3 3" />
// // // // //               <XAxis dataKey="year" />
// // // // //               <YAxis 
// // // // //                 label={{ 
